...
CREATE TABLE `users` (
  ...
  `google_id` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `is_admin`, `google_id`, `remember_token`, `updated_at`, `created_at`) VALUES
(2, 'cani', 'cani@cani.hr', '$2y$10$19YFNgKGDxtSMQ52xALJN.tbSugpJYYli30J/mBYW/Hhfs.QXMv92', 0, NULL, NULL, '2023-06-17 15:19:35', '2023-06-17 15:19:35'),
(3, 'ante', 'ante@ante.ba', '$2y$10$tDp2cjktZv8UmOmjEcZ8IuqAu9z4s0TRndoRSaqBHsZj5V3ijVwm6', 0, NULL, NULL, '2023-06-17 15:35:55', '2023-06-17 15:35:55'),
(4, 'Antonio Pavkovic', 'antoniopavkovic999@gmail.com', '$2y$10$NYrwpGryyMdfPC5SF9PJAeLRS5AoXbdSbx/RolfOHr9m/dFq1yhva', 1, '100076397029191315740', NULL, '2023-06-17 15:42:43', '2023-06-17 15:42:43'),
(5, 'milica', 'milica@milica.ba', '$2y$10$2pAYeFaLXyXzlXjlY.24D.TjBaGjK4tVfwMZhZqNIqSle77FAEVdq', 1, NULL, NULL, '2023-09-07 17:39:14', '2023-09-07 17:39:14');
